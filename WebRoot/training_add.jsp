...
//	request.setCharacterEncoding("gb2312");  
	...
	String sql = "insert into Training (TrainingID,BeginDate,EndDate,TrainingType,Description) values(?,?,?,?,?);";
	...
	if (StringUtil.validateNull(TrainingID)) {
		...
		if (result == 0) {
			out.println("对不起，培训信息添加不成功，请您重新输入！<BR>");
			out.println("<a href=\"" + context + "/training_query.jsp\">添加新的培训信息</a><BR>");
		} else {
